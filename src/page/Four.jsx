...
const Four = () => {
    return (
        <>
            <div className=' mt-20 grid grid-cols-1 md:grid-cols-2 px-20 mb-20'>
                <div className='bg-slate-50'>
                    <p className='mt-20 ml-10 text-gray-500 font-semibold text-xl mb-5'>Apple iPhone 12 Pro</p>
                    <h1 className='ml-10 text-5xl font-bold'>The wait is on: <br /> iphone 12 max pro</h1>
                ...
                <div className=''>
                    <img className='' src="https://i.ibb.co/CQRQ3kx/apple-5-new-products-come-out-together-2.jpg" alt="" />
                </div>
            </div>
